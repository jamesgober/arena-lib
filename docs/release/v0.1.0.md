...
Initial scaffold for `arena-lib`. Repository created, standards in place, CI configured, ready for implementation work in Phase 0.2.0.
...
- `Cargo.toml` with MSRV 1.85, edition 2024, Apache-2.0 OR MIT
